...
export function parseSmokeArgs(argv, env = {}) {
  ...
  return {
    ...
    outPng: positional[1] || defaultOutPng(),
    baseline,
  };
}
/** Default screenshot target, relative to the project being tested. */
export function defaultOutPng() {
  return resolve(process.cwd(), "screenshots", "app-builder-preview.png");
}

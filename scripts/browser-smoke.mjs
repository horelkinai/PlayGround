...
// Screenshots stay inside the project being tested. Deriving the root from
// cwd keeps the guard meaningful in any checkout — it used to be the
// hardcoded /workspace, which does not exist outside the platform sandbox.
const outputRoots = [process.cwd()];
